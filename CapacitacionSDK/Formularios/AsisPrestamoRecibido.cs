...
{
    class AsisPrestamoRecibido : AsisPrestamo
    {
        

        public AsisPrestamoRecibido(Application sboaApplication, SAPbobsCOM.Company sboCompany, string pais)
        {
        ...
        public void CargarFormulario()
        {
            try
            {
                ...
                if (!blnFormOpen)
                {
                    ...
                    oXmlDataDocument.Load(System.Windows.Forms.Application.StartupPath + @"/FormulariosXml/AsisPrestamoRecibido.xml");
        ...
        protected override void actualizarUDO(int i, int rDREntry, int transId)
        {
            ...
            UDOObligacionesFinancieras uDOOFRecibida = new UDOObligacionesFinancieras("HCO_OOFR", "HCO_OFR1");            
        ...
        {
            SQL sql = new SQL("ObligacionesFinan.SQL.GetPayOFR.sql");
